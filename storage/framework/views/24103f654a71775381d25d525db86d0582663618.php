                ...
                <div class="col-xl-3">
                    <div class="card sticky-top" style="top:30px">
                        <div class="list-group list-group-flush" id="useradd-sidenav">
                            ...
                            <a href="#useradd-4"
                                class="list-group-item list-group-item-action border-0"><?php echo e(__('Proposal Print Settings')); ?>

                                <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                            </a>
                            <a href="#useradd-10"
                                class="list-group-item list-group-item-action border-0"><?php echo e(__('Retainer Print Settings')); ?>

                                <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                            </a>
                            <a href="#useradd-5"
                                class="list-group-item list-group-item-action border-0"><?php echo e(__('Invoice Print Settings')); ?>

                                <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                            </a>
                            <a href="#useradd-6"
                                class="list-group-item list-group-item-action border-0"><?php echo e(__('Bill Print Settings')); ?>
                                        ...
                                        <div class="card-body pt-0">
                                            <div class=" setting-card">
                                                <div class="logo-content mt-4">
                                                    <a href="<?php echo e($logo . (isset($logo_dark) && !empty($logo_dark) ? $logo_dark : 'logo-dark.png')); ?>"
                                                        target="_blank">
                                                        <img id="blah" alt="your image"
                                                            src="<?php echo e($logo . (isset($logo_dark) && !empty($logo_dark) ? $logo_dark : 'logo-dark.png')); ?>"
                                                ...
                                                <div class="logo-content mt-4">
                                                    <a href="<?php echo e($logo . (isset($logo_light) && !empty($logo_light) ? $logo_light : 'logo-light.png')); ?>"
                                                        ...
                                                        <img id="blah1" alt="your image"
                                                            src="<?php echo e($logo . (isset($logo_light) && !empty($logo_light) ? $logo_light : 'logo-light.png')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-3 my-auto">
                                        <div class="form-group">
                                            <label class="text-dark mb-1" for="SITE_RTL"><?php echo e(__('Enable RTL')); ?></label>
                                            <div class="">
                                        ...
                                        <div class="col-4 my-auto">
                                            ...
                                            <div class="theme-color themes-color">
                                                <input type="hidden" name="color" id="color_value"
                                                    value="<?php echo e($settings['color']); ?>">
                                                <a href="#!"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <?php echo e(Form::text('company_email_from_name', null, ['class' => 'form-control font-style'])); ?>
                                ...
                                <div class="form-check form-switch col-md-6">
                                    ...
                                    <div class="form-check form-switch custom-switch-v1 float-end">
                                        <input type="checkbox" class="form-check-input" name="tax_number"
                                            id="tax_number" <?php echo e($settings['tax_number'] == 'on' ? 'checked' : ''); ?>>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="card-header card-body">
                                        <form id="setting-form" method="post"
                                            ...
                                            <div class="form-group">
                                                <label for="address"
                                                    class="col-form-label"><?php echo e(__('Proposal Print Template')); ?></label>
                        ...
                        <div class="bg-none">
                            <div class="row company-setting">
                                <div class="col-md-4">
                                    <div class="card-header card-body">
                                        <form id="setting-form" method="post"
                                            action="<?php echo e(route('retainer.template.setting')); ?>"
                                            enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            <div class="form-group">
                                                <label for="address"
                                                    class="col-form-label"><?php echo e(__('Retainer Print Template')); ?></label>
                                                <select class="form-control select2" name="retainer_template">
                                                    <?php $__currentLoopData = App\Models\Utility::templateData()['templates']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($key); ?>"
                                                            <?php echo e(isset($settings['retainer_template']) && $settings['retainer_template'] == $key ? 'selected' : ''); ?>>
                                                            <?php echo e($template); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                                        ...
                                                        <div class="col-auto">
                                                            <label class="colorinput">
                                                                <input name="retainer_color" type="radio"
                                                                    value="<?php echo e($color); ?>" class="colorinput-input"
                                                                    <?php echo e(isset($settings['retainer_color']) && $settings['retainer_color'] == $color ? 'checked' : ''); ?>>
                                                                <span class="colorinput-color"
                                                                    style="background: #<?php echo e($color); ?>"></span>
                                                            </label>
                                                        </div>
                                ...
                                <div class="col-md-8">
                                    <?php if(isset($settings['retainer_template']) && isset($settings['retainer_color'])): ?>
                                        <iframe id="retainer_frame" class="w-100 h-100" frameborder="0"
                                            src="<?php echo e(route('retainer.preview', [$settings['retainer_template'], $settings['retainer_color']])); ?>"></iframe>
                                    <?php else: ?>
                                        <iframe id="retainer_frame" class="w-100 h-100" frameborder="0"
                                            src="<?php echo e(route('retainer.preview', ['template1', 'fffff'])); ?>"></iframe>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-none">
                            <div class="row company-setting">
                                <div class="col-md-4">
                                    <div class="card-header card-body">
                                        <form id="setting-form" method="post"
                                            action="<?php echo e(route('invoice.template.setting')); ?>"
                                            enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            <div class="form-group">
                                                <label for="address"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control"
                                                                    ...
                                                                    value="<?php echo e(!isset($company_payment_setting['stripe_key']) || is_null($company_payment_setting['stripe_key']) ? '' : $company_payment_setting['stripe_key']); ?>"
                                                                    id="stripe_key">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control "
                                                                    ...
                                                                    value="<?php echo e(!isset($company_payment_setting['stripe_secret']) || is_null($company_payment_setting['stripe_secret']) ? '' : $company_payment_setting['stripe_secret']); ?>"
                                                                    id="stripe_secret">
                                                            </div>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <div class="mr-2" style="margin-right: 15px;">
                                                                    <div class="border card p-3">
                                                                        <div class="form-check">
                                                                            <label
                                                                                class="form-check-labe text-dark <?php echo e(isset($company_payment_setting['paypal_mode']) && $company_payment_setting['paypal_mode'] == 'sandbox' ? 'active' : ''); ?>">
                                                                                <input type="radio" name="paypal_mode"
                                                                                    value="sandbox"
                                                                                    class="form-check-input"
                                                                                    <?php echo e(isset($company_payment_setting['paypal_mode']) && $company_payment_setting['paypal_mode'] == 'sandbox' ? 'checked="checked"' : ''); ?>>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="paypal_secret_key"
                                                                    ...
                                                                    value="<?php echo e(!isset($company_payment_setting['paypal_secret_key']) || is_null($company_payment_setting['paypal_secret_key']) ? '' : $company_payment_setting['paypal_secret_key']); ?>"
                                                        ...
                                                        <div class="col-6 py-2 text-end">
                                                            <div class="form-check form-switch d-inline-block">
                                                                ...
                                                                <input type="checkbox" class="form-check-input"
                                                                    ...
                                                                    <?php echo e(isset($company_payment_setting['is_paystack_enabled']) && $company_payment_setting['is_paystack_enabled'] == 'on' ? 'checked' : ''); ?>>
                                                                <label class="custom-control-label form-label"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="paystack_public_key"
                                                                    ...
                                                                    value="<?php echo e(!isset($company_payment_setting['paystack_public_key']) || is_null($company_payment_setting['paystack_public_key']) ? '' : $company_payment_setting['paystack_public_key']); ?>"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="paystack_secret_key"
                                                                    ...
                                                                    value="<?php echo e(!isset($company_payment_setting['paystack_secret_key']) || is_null($company_payment_setting['paystack_secret_key']) ? '' : $company_payment_setting['paystack_secret_key']); ?>"
                                                                    placeholder="<?php echo e(__('Secret Key')); ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-6 py-2 text-end">
                                                            <div class="form-check form-switch d-inline-block">
                                                                ...
                                                                <input type="checkbox" class="form-check-input"
                                                                    ...
                                                                    <?php echo e(isset($company_payment_setting['is_flutterwave_enabled']) && $company_payment_setting['is_flutterwave_enabled'] == 'on' ? 'checked' : ''); ?>>
                                                                <label class="custom-control-label form-label"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="flutterwave_public_key"
                                                                    ...
                                                                    value="<?php echo e(!isset($company_payment_setting['flutterwave_public_key']) || is_null($company_payment_setting['flutterwave_public_key']) ? '' : $company_payment_setting['flutterwave_public_key']); ?>"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="flutterwave_secret_key"
                                                                    ...
                                                                    value="<?php echo e(!isset($company_payment_setting['flutterwave_secret_key']) || is_null($company_payment_setting['flutterwave_secret_key']) ? '' : $company_payment_setting['flutterwave_secret_key']); ?>"
                                                        ...
                                                        <div class="col-6 py-2 text-end">
                                                            <div class="form-check form-switch d-inline-block">
                                                                ...
                                                                <input type="checkbox" class="form-check-input"
                                                                    ...
                                                                    <?php echo e(isset($company_payment_setting['is_mercado_enabled']) && $company_payment_setting['is_mercado_enabled'] == 'on' ? 'checked' : ''); ?>>
                                                                <label class="custom-control-label form-label"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="paytm_merchant_id"
                                                                    ...
                                                                    value="<?php echo e(!isset($company_payment_setting['paytm_merchant_id']) || is_null($company_payment_setting['paytm_merchant_id']) ? '' : $company_payment_setting['paytm_merchant_id']); ?>"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="paytm_merchant_key"
                                                                    ...
                                                                    value="<?php echo e(!isset($company_payment_setting['paytm_merchant_key']) || is_null($company_payment_setting['paytm_merchant_key']) ? '' : $company_payment_setting['paytm_merchant_key']); ?>"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="paytm_industry_type"
                                                                    ...
                                                                    value="<?php echo e(!isset($company_payment_setting['paytm_industry_type']) || is_null($company_payment_setting['paytm_industry_type']) ? '' : $company_payment_setting['paytm_industry_type']); ?>"
                                                        ...
                                                        <div class="col-6 py-2 text-end">
                                                            <div class="form-check form-switch d-inline-block">
                                                                ...
                                                                <input type="checkbox" class="form-check-input"
                                                                    ...
                                                                    <?php echo e(isset($company_payment_setting['is_mollie_enabled']) && $company_payment_setting['is_mollie_enabled'] == 'on' ? 'checked' : ''); ?>>
                                                                <label class="custom-control-label form-label"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="skrill_email"
                                                                    ...
                                                                    value="<?php echo e(!isset($company_payment_setting['skrill_email']) || is_null($company_payment_setting['skrill_email']) ? '' : $company_payment_setting['skrill_email']); ?>"
                                                        ...
                                                        <div class="col-6 py-2 text-end">
                                                            <div class="form-check form-switch d-inline-block">
                                                                ...
                                                                <input type="checkbox" class="form-check-input"
                                                                    ...
                                                                    <?php echo e(isset($company_payment_setting['is_coingate_enabled']) && $company_payment_setting['is_coingate_enabled'] == 'on' ? 'checked' : ''); ?>>
                                                                <label class="custom-control-label form-label"
                                                        ...
                                                        <div class="col-6 py-2 text-end">
                                                            <div class="form-check form-switch d-inline-block">
                                                                ...
                                                                <input type="checkbox" class="form-check-input"
                                                                    ...
                                                                    <?php echo e(isset($company_payment_setting['is_paymentwall_enabled']) && $company_payment_setting['is_paymentwall_enabled'] == 'on' ? 'checked' : ''); ?>>
                                                                <label class="custom-control-label form-label"
                                            ...
                                            <div class="list-group">
                                                <div class="list-group-item form-switch form-switch-right">
                                                    ...
                                                    <input class="form-check-input email-template-checkbox"
                                                        id="email_tempalte_<?php echo e(!empty($EmailTemplate->template) ? $EmailTemplate->template->id : ''); ?>"
                                                        type="checkbox"
                                                        <?php if(!empty($EmailTemplate->template) ? $EmailTemplate->template->is_active : 0 == 1): ?> checked="checked" <?php endif; ?>
                                                        type="checkbox"
                                                        value="<?php echo e(!empty($EmailTemplate->template) ? $EmailTemplate->template->is_active : 1); ?>"
                                                        data-url="<?php echo e(route('status.email.language', [!empty($EmailTemplate->template) ? $EmailTemplate->template->id : ''])); ?>" />
                                                    <label class="form-check-label"
                                                        for="email_tempalte_<?php echo e(!empty($EmailTemplate->template) ? $EmailTemplate->template->id : ''); ?>"></label>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Faraz\Downloads\accountgosaas-51nulled\codecanyon-25733019-accountgo-saas-accounting-and-billing-tool\main_file\resources\views/settings/company.blade.php ENDPATH**/ ?>