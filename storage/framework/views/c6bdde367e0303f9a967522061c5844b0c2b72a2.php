        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create plan')): ?>
            <?php if(isset($admin_payment_setting) && !empty($admin_payment_setting)): ?>
                <?php if(
                    ...
                    <a href="#" data-url="<?php echo e(route('plans.create')); ?>" data-ajax-popup="true" data-bs-toggle="tooltip"
                        title="<?php echo e(__('Create')); ?>" data-title="<?php echo e(__('Create New Plan')); ?>" class="btn btn-sm btn-primary">
                ...
                <div class="card price-card price-1 wow animate__fadeInUp" data-wow-delay="0.2s"
                   ...
                   ">
                    <div class="card-body">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit plan')): ?>
                            <div class="d-flex flex-row-reverse m-0 p-0">
                                <div class="action-btn bg-primary ms-2">
                                    <a title="<?php echo e(__('Edit Plan')); ?>" href="#"
                                        class="mx-3 btn btn-sm d-inline-flex align-items-center"
                                        data-url="<?php echo e(route('plans.edit', $plan->id)); ?>" data-ajax-popup="true"
                                        data-bs-title="<?php echo e(__('Edit Plan')); ?>" data-bs-toggle="tooltip"
                        ...
                        <p class="mb-0">
                            <?php echo e(__('Duration : ') . __(\App\Models\Plan::$arrDuration[$plan->duration] ?? 'Unknown')); ?><br />
                        </p>
                                                ...
                                                <?php if($plan->id != \Auth::user()->plan): ?>
                                                    <?php if($plan->price > 0): ?>
                                                        <a href="<?php echo e(route('stripe', \Illuminate\Support\Facades\Crypt::encrypt($plan->id))); ?>"
                                                            ...
                                                            data-bs-original-title="Subscribe"><?php echo e(__('Subscribe')); ?> <i
                                                                class="fas fa-arrow-right m-1"></i>
                                                        </a>
                                                    <?php else: ?>
                                            ...
                                            <div class="col-3">
                                                <?php if(\Auth::user()->requested_plan != $plan->id): ?>
                                                    <a href="<?php echo e(route('send.request', [\Illuminate\Support\Facades\Crypt::encrypt($plan->id)])); ?>"
                                                        class="btn btn-primary btn-icon btn-sm" data-title="Send Request"
                                                        data-bs-toggle="tooltip" data-bs-placement="top" title=""
                                                        data-bs-original-title="Send Request">
                                                        <span class="btn-inner--icon"><i class="fas fa-share"></i></span>
                                                    </a>
                                                <?php else: ?>
                                                    <a href="<?php echo e(route('request.cancel', \Auth::user()->id)); ?>"
                                                        class="btn btn-danger btn-icon btn-sm" data-title="Cancel Request"
                                                        data-bs-toggle="tooltip" data-bs-placement="top" title=""
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Faraz\Downloads\accountgosaas-51nulled\codecanyon-25733019-accountgo-saas-accounting-and-billing-tool\main_file\resources\views/plan/index.blade.php ENDPATH**/ ?>