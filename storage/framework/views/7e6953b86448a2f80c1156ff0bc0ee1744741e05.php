        ...
        <div class="auth-footer">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-6 ">
                        <p class="">
                            <?php echo e((Utility::getValByName('footer_text')) ? Utility::getValByName('footer_text') :  __('Copyright AccountGo-SaaS')); ?> <?php echo e(date('Y')); ?>
...
<?php /**PATH C:\Users\Faraz\Downloads\accountgosaas-51nulled\codecanyon-25733019-accountgo-saas-accounting-and-billing-tool\main_file\resources\views/layouts/auth.blade.php ENDPATH**/ ?>